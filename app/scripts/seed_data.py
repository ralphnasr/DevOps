...
CATEGORIES = [
    {"name": "Electronics", "description": "Smartphones, laptops, gadgets and accessories"},
    {"name": "Clothing", "description": "Men's and women's fashion apparel"},
    {"name": "Home & Kitchen", "description": "Furniture, appliances and home essentials"},
    {"name": "Sports & Outdoors", "description": "Athletic gear, camping and fitness equipment"},
    {"name": "Books", "description": "Fiction, non-fiction, textbooks and more"},
    {"name": "Beauty & Health", "description": "Skincare, supplements and personal care"},
]
...
PRODUCTS = [
    {
        ...
        "price": 79.99, "category": "Electronics", "stock_quantity": 150, "sales_count": 420,
        "attributes": {"color": "Black", "brand": "SoundMax", "wireless": True, "battery_hours": 30},
    },
    {
        "slug": "charger",
        "name": "USB-C Fast Charger",
        "description": "65W GaN charger compatible with laptops and phones. Dual-port, foldable prongs, travel-ready.",
        "price": 34.99, "category": "Electronics", "stock_quantity": 300, "sales_count": 880,
    ...
    },
    {
        ...
        "price": 129.99, "category": "Electronics", "stock_quantity": 80, "sales_count": 210,
        "attributes": {"switch_type": "Cherry MX Blue", "layout": "Full-size", "backlit": "RGB"},
    },
    {
        "slug": "ssd",
        "name": "Portable SSD 1TB",
        "description": "USB 3.2 portable solid state drive with read speeds up to 1050MB/s. Shock-resistant aluminum shell.",
        "price": 89.99, "category": "Electronics", "stock_quantity": 200, "sales_count": 540,
        "attributes": {"capacity": "1TB", "interface": "USB 3.2", "read_speed": "1050MB/s"},
    },
    {
        "slug": "smartwatch",
        "name": "Smart Watch Pro",
        "description": "Fitness tracker with heart-rate monitor, GPS, and 7-day battery. Swim-proof, syncs to iOS/Android.",
        "price": 199.99, "category": "Electronics", "stock_quantity": 60, "sales_count": 330,
    ...
    },
    {
        ...
        "price": 24.99, "category": "Clothing", "stock_quantity": 500, "sales_count": 1240,
        "attributes": {"gender": "women", "color": "White", "size": "M", "material": "100% Organic Cotton"},
    },
    {
        "slug": "jeans",
        "name": "Slim Fit Denim Jeans",
        "description": "Stretch denim jeans with modern slim fit. Reinforced pockets, button fly, sustainable wash.",
        "price": 59.99, "category": "Clothing", "stock_quantity": 250, "sales_count": 670,
        "attributes": {"gender": "men", "color": "Dark Blue", "size": "32", "material": "98% Cotton, 2% Elastane"},
    },
    {
        "slug": "jacket",
        ...
        "price": 74.99, "category": "Clothing", "stock_quantity": 120, "sales_count": 290,
        "attributes": {"gender": "men", "color": "Navy", "size": "L", "material": "Nylon", "waterproof": True},
    },
    {
        "slug": "sweater",
        "name": "Wool Blend Sweater",
        "description": "Cozy merino wool-blend crew-neck sweater. Pilling-resistant yarn, ribbed hem and cuffs.",
        "price": 89.99, "category": "Clothing", "stock_quantity": 90, "sales_count": 180,
        "attributes": {"gender": "women", "color": "Charcoal", "size": "M", "material": "70% Merino Wool, 30% Nylon"},
    },
    {
        "slug": "waterbottle",
        "name": "Stainless Steel Water Bottle",
        "description": "Double-wall vacuum-insulated 750ml bottle. Keeps drinks cold 24h, hot 12h. Leak-proof lid.",
        "price": 29.99, "category": "Home & Kitchen", "stock_quantity": 400, "sales_count": 1560,
        "attributes": {"capacity": "750ml", "material": "Stainless Steel", "insulated": True},
    },
    {
        "slug": "cookware",
        "name": "Non-Stick Cookware Set",
        "description": "10-piece ceramic non-stick cookware set with tempered-glass lids. Oven-safe to 500°F.",
        "price": 149.99, "category": "Home & Kitchen", "stock_quantity": 45, "sales_count": 95,
        "attributes": {"pieces": 10, "material": "Ceramic Non-Stick", "dishwasher_safe": True},
    },
    {
        "slug": "lamp",
        "name": "LED Desk Lamp",
        "description": "Dimmable LED desk lamp with USB charging port and 5 color modes. Touch controls, memory function.",
        "price": 44.99, "category": "Home & Kitchen", "stock_quantity": 180, "sales_count": 410,
    ...
    },
    {
        ...
        "price": 34.99, "category": "Home & Kitchen", "stock_quantity": 220, "sales_count": 370,
    ...
    },
    {
        ...
        "price": 39.99, "category": "Sports & Outdoors", "stock_quantity": 300, "sales_count": 720,
    ...
    },
    {
        ...
        "price": 179.99, "category": "Sports & Outdoors", "stock_quantity": 35, "sales_count": 110,
    ...
    },
    {
        ...
        "price": 99.99, "category": "Sports & Outdoors", "stock_quantity": 70, "sales_count": 200,
    ...
    },
    {
        ...
        "price": 19.99, "category": "Sports & Outdoors", "stock_quantity": 450, "sales_count": 960,
    ...
    },
    {
        ...
        "price": 37.99, "category": "Books", "stock_quantity": 100, "sales_count": 340,
        "attributes": {"author": "Robert C. Martin", "pages": 464, "format": "Paperback"},
    },
    {
        "slug": "ddia",
        "name": "Designing Data-Intensive Applications",
        "description": "The Big Ideas Behind Reliable, Scalable, and Maintainable Systems by Martin Kleppmann.",
        "price": 44.99, "category": "Books", "stock_quantity": 85, "sales_count": 260,
        "attributes": {"author": "Martin Kleppmann", "pages": 616, "format": "Paperback"},
    },
    {
        "slug": "pragmatic",
        "name": "The Pragmatic Programmer",
        "description": "Your Journey to Mastery, 20th Anniversary Edition. Hardcover with ribbon bookmark.",
        "price": 49.99, "category": "Books", "stock_quantity": 120, "sales_count": 280,
        "attributes": {"author": "David Thomas, Andrew Hunt", "pages": 352, "format": "Hardcover"},
    },
    {
        "slug": "vitaminc",
        "name": "Vitamin C Serum",
        "description": "20% Vitamin C face serum with hyaluronic acid and vitamin E. Cruelty-free, 30ml.",
        "price": 24.99, "category": "Beauty & Health", "stock_quantity": 350, "sales_count": 820,
    ...
    },
    {
        ...
        "price": 18.99, "category": "Beauty & Health", "stock_quantity": 500, "sales_count": 1420,
    ...
    },
    {
        ...
        "price": 39.99, "category": "Beauty & Health", "stock_quantity": 160, "sales_count": 490,
...
REVIEW_POOL = {
    5: [
        ("Exceeded expectations", "Easily the best purchase I've made this year. Shipping was fast and quality is outstanding."),
        ("Worth every penny", "Packaging was beautiful, build quality feels premium, and it performs exactly as described."),
        ("Highly recommend", "I was hesitant at first but I'm so glad I bought it. Already recommending to friends."),
        ("Perfect", "Works flawlessly. Instructions were clear and setup took under five minutes."),
        ("Five-star experience", "From ordering to unboxing, everything was seamless. I'll definitely shop here again."),
    ],
    4: [
        ("Really good", "Very happy with this. Only docking a star because the color is slightly different from the photos."),
        ("Solid choice", "Does exactly what it says. Build could be slightly more premium but the value is there."),
        ("Great value", "Honest review: good product, fair price, fast delivery. Nothing to complain about."),
    ],
    3: [
        ("Decent for the price", "It's okay. Does the job but don't expect luxury at this price point."),
        ("Mixed feelings", "Works as advertised but I had to contact support once. They resolved it quickly."),
    ],
}


AUTHOR_POOL = [
    ("Alex Rivera", True), ("Priya Shah", True), ("Jordan Park", False),
    ("Sofia Martinez", True), ("Noah Chen", True), ("Emma Wright", False),
    ("Liam O'Brien", True), ("Maya Patel", True), ("Diego Fernandez", False),
    ("Zara Khan", True), ("Oliver Tanaka", True), ("Aisha Bakr", False),
    ("Ethan Kowalski", True), ("Mia Nakamura", True), ("Samir Haddad", True),
]
...
COUPONS = [
    {
        "code": "SAVE10", "description": "10% off sitewide. Minimum $20.",
        "discount_type": "percent", "discount_value": 10,
        "min_order_amount": 20, "max_uses": None, "is_active": True,
    },
    {
        "code": "WELCOME5", "description": "$5 off your first order. Minimum $25.",
        "discount_type": "fixed", "discount_value": 5,
        "min_order_amount": 25, "max_uses": None, "is_active": True,
    },
]
...
TESTIMONIALS = [
    {
        "author_name": "Sarah M.", "author_title": "Verified Buyer",
        "avatar_initials": "SM", "rating": 5,
        "quote": "Love the selection and how fast everything ships. My go-to store for thoughtful gifts.",
        "sort_order": 1,
    },
    {
        "author_name": "David K.", "author_title": "Member since 2024",
        "avatar_initials": "DK", "rating": 5,
        "quote": "Checkout is smooth and the coupons actually work. Returns were painless too.",
        "sort_order": 2,
    },
    {
        "author_name": "Jenna L.", "author_title": "Verified Buyer",
        "avatar_initials": "JL", "rating": 4,
